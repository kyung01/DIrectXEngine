...
bool RenderTexture::init(ID3D11Device *device, IDXGISwapChain * swapChain, int textureWidth, int textureHeight)
{
	release();
...
bool RenderTexture::initCubeArray(ID3D11Device* device, int textureWidth, int textureHeight, int arraySize, void * data)
{
	release();
	m_isInitialized = true;
	m_width = textureWidth;
...
ID3D11Texture2D * RenderTexture::getShaderResource()
{
