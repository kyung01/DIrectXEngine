...
void ISimpleShader::initConstantBuffer(ID3D11ShaderReflection * refl, SimpleConstantBuffer * constantBuffers, int constantBufferCount)
{
	// Loop through all constant buffers
	for (unsigned int b = 0; b < constantBufferCount; b++)
	{
		constantBuffers[b].isManual = false;
		// Get this buffer
...
void ISimpleShader::initConstantBufferUnique(ID3D11ShaderReflection * refl, SimpleConstantBuffer * constantBuffers, int constantBufferCount, std::list<int> arguments)
{
...
void ISimpleShader::CopyAllBufferData()
{
	...
	for (unsigned int i = 0; i < constantBufferCount; i++)
	{
		if (constantBuffers[i].isManual) continue;
...
ID3D11Buffer * ISimpleShader::GetBuffer(int n)
{
