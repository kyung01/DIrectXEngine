...
#include <Engine\Systems\ClusteredFrustumLightCoolingSystem.h>
#include <iostream>

using namespace DirectX::SimpleMath;
using namespace KEngine::KSystem;

Vector3 ClusteredFrustumLightCoolingSystem::getMaxVector(Vector3 & a, Vector3 & b)
{
return Vector3(max(a.x, b.x), max(a.y, b.y), max(a.z, b.z));
}
Vector3 ClusteredFrustumLightCoolingSystem::getMinVector(Vector3 & a, Vector3 & b)
{
return Vector3(min(a.x, b.x), min(a.y, b.y), min(a.z, b.z));
}
bool ClusteredFrustumLightCoolingSystem::aabbArvo(Vector3 C1, Vector3 C2, Vector3 S, float R)
{
...
void ClusteredFrustumLightCoolingSystem::init(float widthOverHeight, float nearDistance, float farDistance, int divisionX, int divisionY, int divisionZ)
{
...
void ClusteredFrustumLightCoolingSystem::testBegin()
{
...
void ClusteredFrustumLightCoolingSystem::testPointlight(int lightIndex, Vector3 center, float radius)
{
	int index;
...
void ClusteredFrustumLightCoolingSystem::testSpotlight(int lightIndex, Vector3 vertex, Vector3 axis, float H, float alpha)
{
...
bool ClusteredFrustumLightCoolingSystem::testSpotlight(
...
void KEngine::KSystem::ClusteredFrustumLightCoolingSystem::addEntity(Entity & entity)
{
}

bool ClusteredFrustumLightCoolingSystem::testPointlight(std::pair<int, int> &result, std::vector<Plane> planes, Vector3 center, float radius) {
