		...
		for (int k = 0; k < divisionZ; k++) {
			...
			for (int j = 0; j < divisionY; j++) {
				for (int i = 0; i < divisionX; i++) {
					...
					cube.rightTopNear = DirectXSimpleMath::GetCombinedMax(DirectXSimpleMath::GetCombinedMax(DirectXSimpleMath::GetCombinedMax(DirectXSimpleMath::GetCombinedMax(DirectXSimpleMath::GetCombinedMax(DirectXSimpleMath::GetCombinedMax(DirectXSimpleMath::GetCombinedMax(cube.a0, cube.a1), cube.a2), cube.a3), cube.b0), cube.b1), cube.b2), cube.b3);
					cube.leftBottomFar = DirectXSimpleMath::GetCombinedMin(DirectXSimpleMath::GetCombinedMin(DirectXSimpleMath::GetCombinedMin(DirectXSimpleMath::GetCombinedMin(DirectXSimpleMath::GetCombinedMin(DirectXSimpleMath::GetCombinedMin(DirectXSimpleMath::GetCombinedMin(cube.a0, cube.a1), cube.a2), cube.a3), cube.b0), cube.b1), cube.b2), cube.b3);
				}
			}
		}
